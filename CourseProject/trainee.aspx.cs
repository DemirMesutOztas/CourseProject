...
namespace CourseProject
{
    public partial class trainee : System.Web.UI.Page
    {
        ...
        protected void user_kaydet_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand gonder = new SqlCommand("insert into trainee (name,surname,email,phone,age,education, password, password_again ) values('" + t_txt_adi.Text + "','" + t_txt_surname.Text 
                                               + "','" + t_txt_email.Text + "','" 
                                               + t_txt_phone.Text + "','" + t_txt_age.Text + "','" + t_txt_education.Text + "','" 
